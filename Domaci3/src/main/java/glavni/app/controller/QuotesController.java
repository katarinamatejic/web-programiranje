...
public class QuotesController extends Controller{
    ...
    public Response doGET() {
        ...
        if (QuoteStorage.getInstance().getSelQuote() == null) { //prvi put zove getter i preko pomocnog servisa vadi neki random citat
        ...
        StringBuilder html = new StringBuilder("<br> <br>" +
                ...
                "<h1> Saved quotes </h1>");
        Iterator iterator = QuoteStorage.getInstance().getQuotes().iterator(); //prolazi kroz citate koje sam ja dodala i smesta ih u tabelu
        html.append("<table>" +
                "<tr>" +
                "<th></th>" +
                "</tr>");
        ...
        return new HTMLResponse(html.toString()); //vraca response
    }

    @Override
    public Response doPOST() {
        //dugme sacuvak i u quote storage mi doda moj novi citat tako sto parametri za citat se nalaze u post parametrima requesta i vraca mi redirect response
